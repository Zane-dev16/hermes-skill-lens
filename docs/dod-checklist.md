...
| 4 | Core pack 30–40 rules, corpus-tested both ways | ✅* | **41 rules** in skill_lens/rules/core/rules/ — retained per owner ruling D-060 (deterministic rules scale on merit; 30–40 was planning budget, not hard cap; bloat still forbidden). Coverage complete both ways (43 malicious / 33 benign fixtures) |
